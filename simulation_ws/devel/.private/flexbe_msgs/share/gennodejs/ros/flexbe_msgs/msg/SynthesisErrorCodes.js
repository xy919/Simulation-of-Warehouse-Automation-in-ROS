...
class SynthesisErrorCodes {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SynthesisErrorCodes(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SynthesisErrorCodes(null);
...
SynthesisErrorCodes.Constants = {
  SUCCESS: 1,
}

module.exports = SynthesisErrorCodes;
