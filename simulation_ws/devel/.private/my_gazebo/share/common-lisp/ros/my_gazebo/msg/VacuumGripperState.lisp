...
(cl:defmethod cl:initialize-instance :after ((m <VacuumGripperState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VacuumGripperState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_gazebo-msg:<VacuumGripperState> is deprecated: use my_gazebo-msg:VacuumGripperState instead.")))

(cl:ensure-generic-function 'enabled-val :lambda-list '(m))
(cl:defmethod enabled-val ((m <VacuumGripperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_gazebo-msg:enabled-val is deprecated.  Use my_gazebo-msg:enabled instead.")
  (enabled m))

(cl:ensure-generic-function 'attached-val :lambda-list '(m))
(cl:defmethod attached-val ((m <VacuumGripperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_gazebo-msg:attached-val is deprecated.  Use my_gazebo-msg:attached instead.")
  (attached m))
