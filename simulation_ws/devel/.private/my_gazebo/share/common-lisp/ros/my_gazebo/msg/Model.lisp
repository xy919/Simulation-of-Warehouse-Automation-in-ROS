...
(cl:defmethod cl:initialize-instance :after ((m <Model>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Model)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_gazebo-msg:<Model> is deprecated: use my_gazebo-msg:Model instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <Model>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_gazebo-msg:type-val is deprecated.  Use my_gazebo-msg:type instead.")
  (type m))
