...
(cl:defclass <LogicalCameraImage> (roslisp-msg-protocol:ros-message)
  ((models
    :reader models
    :initarg :models
    :type (cl:vector my_gazebo-msg:Model)
   :initform (cl:make-array 0 :element-type 'my_gazebo-msg:Model :initial-element (cl:make-instance 'my_gazebo-msg:Model)))
   (pose
    :reader pose
    :initarg :pose
...
(cl:defmethod cl:initialize-instance :after ((m <LogicalCameraImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LogicalCameraImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_gazebo-msg:<LogicalCameraImage> is deprecated: use my_gazebo-msg:LogicalCameraImage instead.")))

(cl:ensure-generic-function 'models-val :lambda-list '(m))
(cl:defmethod models-val ((m <LogicalCameraImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_gazebo-msg:models-val is deprecated.  Use my_gazebo-msg:models instead.")
  (models m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <LogicalCameraImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_gazebo-msg:pose-val is deprecated.  Use my_gazebo-msg:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LogicalCameraImage>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'models)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'my_gazebo-msg:Model))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LogicalCameraImage>)))
  ...
  (cl:format cl:nil "# Logical camera image message~%Model[] models                  # models detected (poses in the frame of the camera)~%geometry_msgs/Pose pose         # camera pose~%~%================================================================================~%MSG: my_gazebo/Model~%string type                     # model type~%geometry_msgs/Pose pose         # model pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LogicalCameraImage)))
  "Returns full string definition for message of type 'LogicalCameraImage"
  (cl:format cl:nil "# Logical camera image message~%Model[] models                  # models detected (poses in the frame of the camera)~%geometry_msgs/Pose pose         # camera pose~%~%================================================================================~%MSG: my_gazebo/Model~%string type                     # model type~%geometry_msgs/Pose pose         # model pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
