...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorBeltState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorBeltState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_gazebo-msg:<ConveyorBeltState> is deprecated: use my_gazebo-msg:ConveyorBeltState instead.")))

(cl:ensure-generic-function 'power-val :lambda-list '(m))
(cl:defmethod power-val ((m <ConveyorBeltState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_gazebo-msg:power-val is deprecated.  Use my_gazebo-msg:power instead.")
  (power m))
