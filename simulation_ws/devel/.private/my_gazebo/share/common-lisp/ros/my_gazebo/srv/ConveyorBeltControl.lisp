...
(cl:defclass <ConveyorBeltControl-request> (roslisp-msg-protocol:ros-message)
  ((state
    :reader state
    :initarg :state
    :type my_gazebo-msg:ConveyorBeltState
    :initform (cl:make-instance 'my_gazebo-msg:ConveyorBeltState)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorBeltControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorBeltControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_gazebo-srv:<ConveyorBeltControl-request> is deprecated: use my_gazebo-srv:ConveyorBeltControl-request instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <ConveyorBeltControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_gazebo-srv:state-val is deprecated.  Use my_gazebo-srv:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConveyorBeltControl-request>)))
  ...
  "my_gazebo/ConveyorBeltControlRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConveyorBeltControl-request)))
  "Returns string type for a service object of type 'ConveyorBeltControl-request"
  "my_gazebo/ConveyorBeltControlRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConveyorBeltControl-request>)))
  ...
  (cl:format cl:nil "# Conveyor belt control~%~%# desired conveyor belt state~%ConveyorBeltState state~%~%~%================================================================================~%MSG: my_gazebo/ConveyorBeltState~%# Conveyor belt state message~%float64 power    # power of the belt (percentage, in +Y direction of belt frame)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConveyorBeltControl-request)))
  "Returns full string definition for message of type 'ConveyorBeltControl-request"
  (cl:format cl:nil "# Conveyor belt control~%~%# desired conveyor belt state~%ConveyorBeltState state~%~%~%================================================================================~%MSG: my_gazebo/ConveyorBeltState~%# Conveyor belt state message~%float64 power    # power of the belt (percentage, in +Y direction of belt frame)~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorBeltControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorBeltControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_gazebo-srv:<ConveyorBeltControl-response> is deprecated: use my_gazebo-srv:ConveyorBeltControl-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ConveyorBeltControl-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_gazebo-srv:success-val is deprecated.  Use my_gazebo-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConveyorBeltControl-response>)))
  ...
  "my_gazebo/ConveyorBeltControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConveyorBeltControl-response)))
  "Returns string type for a service object of type 'ConveyorBeltControl-response"
  "my_gazebo/ConveyorBeltControlResponse")
