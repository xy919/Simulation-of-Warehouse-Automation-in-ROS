...
#include <ros/ros.h>
#include <sdf/sdf.hh>
#include "my_gazebo/plugins/ROSVacuumGripperPlugin.hh"
#include "my_gazebo/VacuumGripperControl.h"
#include "my_gazebo/VacuumGripperState.h"
    ...
    sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->advertise<
    my_gazebo::VacuumGripperState>(stateTopic, 1000);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  my_gazebo::VacuumGripperControl::Request &_req,
  my_gazebo::VacuumGripperControl::Response &_res)
{
...
{
  my_gazebo::VacuumGripperState msg;
