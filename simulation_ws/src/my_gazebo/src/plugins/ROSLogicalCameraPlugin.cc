...
#include "my_gazebo/plugins/ROSLogicalCameraPlugin.hh"

#include "my_gazebo/plugins/ARIAC.hh"
#include "my_gazebo/LogicalCameraImage.h"
...
void ROSLogicalCameraPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->imagePub = this->rosnode->advertise<my_gazebo::LogicalCameraImage>(imageTopic_ros, 1, false);
...
void ROSLogicalCameraPlugin::OnImage(ConstLogicalCameraImagePtr &_msg)
{
    ...
    my_gazebo::LogicalCameraImage imageMsg;
