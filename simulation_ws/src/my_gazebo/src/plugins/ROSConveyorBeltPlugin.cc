 ...
 *
*/
#include "my_gazebo/plugins/ROSConveyorBeltPlugin.hh"
...
bool ROSConveyorBeltPlugin::OnControlCommand(ros::ServiceEvent<
  my_gazebo::ConveyorBeltControl::Request, my_gazebo::ConveyorBeltControl::Response> & event)
{
  const my_gazebo::ConveyorBeltControl::Request& req = event.getRequest();
  my_gazebo::ConveyorBeltControl::Response& res = event.getResponse();
