...
@author: xinyinhoe
'''
class turtlebot_demo2SM(Behavior):
	'''
	...
	def __init__(self):
		super(turtlebot_demo2SM, self).__init__()
		self.name = 'turtlebot_demo2'
	...
	def create(self):
		...
		robot_loc_2 = Pose2D(x=-2.48, y=-2.4, theta=3.145)
		...
		_state_machine.userdata.robot_loc_2 = robot_loc_2
		...
		with _state_machine:
			...
			OperatableStateMachine.add('MoveTurtlebot1',
										...
										remapping={'waypoint': 'robot_loc_2'})
